...
('1649', 'ResoluciÃ³n de Problemas y Algoritmos', 2, 'Problemas. Algoritmos. Operadores aritmï¿½ticos y lï¿½gicos. Estructuras de control. Nociï¿½n de modularizaciï¿½n. Estructuras de datos lineales: Arreglos. Pilas. Colas. Algoritmos fundamentales: recorrido, bï¿½squeda, ordenamiento, actualizaciï¿½n. Recursividad.', 5, 8),
...
('1658', 'AnÃ¡lisis y DiseÃ±o de Software', 2, 'daasasdsad', 9, 6),
('1659', 'Bases de Datos', 2, 'asdasdasdasd', 10, 6),
('1663', 'ValidaciÃ³n y VerificaciÃ³n de Software', 2, 'asdasdasdsd', 9, 4),
('1668', 'GestiÃ³n de Proyectos de Software', 2, 'Conceptos de gestiÃ³n, PlanificaciÃ³n de proyectos. MÃ©tricas y estimaciÃ³n de costos, esfuerzo y tiempo. Riesgos. OrganizaciÃ³n y personal de proyecto. Control de proyecto. GestiÃ³n de configuraciones de software. ImplantaciÃ³n y EvoluciÃ³n del software', 4, 6),
('1673', 'GestiÃ³n de Calidad', 2, 'asdasdasdasd', 4, 4),
...
(7, 18732763, 'Leonardo', 'GonzÃ¡lez', 'lgonzalez@uarg.unpa.edu.ar', 'cat2', '', 2),
...
CREATE TABLE `programa` (
  ...
  `horasTeoria` decimal(4,2) NOT NULL,
  `horasPractica` decimal(4,2) NOT NULL,
  `horasOtros` decimal(4,2) DEFAULT NULL,
