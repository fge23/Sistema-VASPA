            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-danger" role="alert">
                        La operaci&oacute;n no pudo ser realizada debido a que no se han seleccionado asignaturas correlativas.
                    </div>
                    <?php } ?>
                    <hr />
                    <h5 class="card-text">Opciones</h5>
                    <a href="asignaturas.correlativas.php?idAsignatura=<?= $idAsignatura?>&idPlan=<?= $idPlan?>">
